...
var game = new Phaser.Game(400, 680, Phaser.CANVAS, 'game');
game.States = {};
game.States.boot = function() {
  this.preload = function() {
    ...
    game.load.image('loading', 'games/2048/assets/preloader.gif');
  };
...
game.States.preload = function() {
  this.preload = function() {
    ...
    game.load.image('background', 'games/2048/assets/bg.png');
    game.load.image('btnStart', 'games/2048/assets/btn-start.png');
    game.load.image('btnRestart', 'games/2048/assets/btn-restart.png');
    game.load.image('logo', 'games/2048/assets/logo.png');
    game.load.image('btnTryagain', 'games/2048/assets/btn-tryagain.png');
  };
  this.create = function() {
