...
game.States.preload = function() {
    this.preload = function() {
        ...
        game.load.image('btnStart', 'assets/images/btn-start.png');
        game.load.image('btnRestart', 'assets/images/btn-restart.png');
        game.load.image('logo', 'assets/images/logo.png');
        game.load.image('btnTryagain', 'assets/images/btn-tryagain.png');
    };
    this.create = function() {
