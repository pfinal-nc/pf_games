        ...
        if (result !== "") {
            ...
            $.each(JSON.parse(result), function (i, item) {
                data_tr +=' <tr class="text-white border border-gray-400 hover:bg-gray-400">\n' +
                    ...
                    '</svg>\n</a>' +
                    '<a class="text-xs float-left ml-2 hover:text-red-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">\n' +
